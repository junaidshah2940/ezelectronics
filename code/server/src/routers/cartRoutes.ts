...
class CartRoutes {
    ...
    initRoutes() {
        ...
        this.router.post(
            "/", this.authenticator.isLoggedIn, this.authenticator.isCustomer,
            body('model').notEmpty().isString().withMessage('Model must be a non-empty string'),
         ...
         */
        this.router.delete(
            "/current", this.authenticator.isLoggedIn, this.authenticator.isCustomer,
         ...
         */
        this.router.get(
            "/all", this.authenticator.isLoggedIn, this.authenticator.isAdminOrManager,
